...
public class Tast_3 {
    ...
    public static void main(String[] args) throws IOException {
        Tast_3 test = new Tast_3();
        test.initialise(cabins);
        test.printMenu();
    ...
    public void alphabeticallyOrder() {
        int count = 0;
    ...
    private void initialise(Cabin[] cruiseRef) {
        for (int x = 0; x < cabins.length; x++) {
            cruiseRef[x] = new Cabin();
        }
    }

    private void showEmptyCabins() {
        for (int n = 0; n < 12; n++) {
